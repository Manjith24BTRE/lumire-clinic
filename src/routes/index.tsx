        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a href="https://www.instagram.com/mavros_ai?igsh=bm0wNmJ3MjJjbGEz&utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full grid place-items-center glass hover:text-primary transition">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="https://www.linkedin.com/company/mavros-tech/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-9 h-9 rounded-full grid place-items-center glass hover:text-primary transition">
